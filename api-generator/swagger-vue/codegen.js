...
const apiTemplate = fs.readFileSync(path.join(__dirname, './templates/api.hbs'), 'utf-8')
const methods = fs.readFileSync(path.join(__dirname, './templates/methods.hbs'), 'utf-8')
const method = fs.readFileSync(path.join(__dirname, './templates/method.hbs'), 'utf-8')
